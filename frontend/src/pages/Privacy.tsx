    ...
    <div>
      ...
      <div className="privacy-wrapper">
        ...
        <p className="mb-6">
          ...
          classics, international cinema, indie films, and niche documentaries.
          This privacy policy explains how CineNiche collects, uses, and
          protects the personal data you provide when using our website and
          streaming services.
        </p>
        ...
        <p>
          ...
          the EU and the US, protected with industry-standard access controls
          and other regular security updates.
        </p>
        <p>
        ...
        <p>
          ...
          CineNiche, we may collect data automatically through cookies or
          similar technologies. For more details, visit{' '}
          <a
        ...
        <p>
          CineNiche regularly reviews and updates this policy. All changes will
          be posted on this page. This version was last updated on April 11,
          2025.
        </p>
