...
const Privacy: React.FC = () => {
  return (
    <div className="privacy-wrapper">
      ...
      <p className="mb-6">
        CineNiche is a streaming platform dedicated to delivering cult classics,
        international cinema, indie films, and niche documentaries. This privacy
        policy explains how CineNiche collects, uses, and protects the personal
        data you provide when using our website and streaming services.
      </p>
      ...
      <ul>
        <li>
          Personal identification information (e.g., name, age, gender, phone,
          email, city/state, zip, etc.)
        </li>
        <li>Movie ratings</li>
      ...
      <p>
        If you agree, CineNiche may share limited, anonymized data to enhance
      ...
      <p>
        CineNiche securely stores your data on encrypted servers hosted within
        the EU and the US, protected with industry-standard access controls and
        other regular security updates.
      </p>
      <p>
        We retain your account and usage data for as long as your account is
        active. If you delete your account, we will remove personal data within
      ...
      <ul>
        ...
        <li>
          The right to rectification – Request correction of any inaccurate or
          incomplete data.
        </li>
        <li>
        ...
        <li>
          The right to object to processing – Object to how we use your data for
          specific purposes.
        </li>
        <li>
      ...
      <p>
        ...
        internet log data and visitor behavior information. When you visit
        CineNiche, we may collect data automatically through cookies or similar
        technologies. For more details, visit{' '}
        <a
      ...
      <ul>
        ...
        <li>
          <strong>Analytics cookies:</strong> Understand how users interact with
          our site
        </li>
      </ul>
      ...
      <h2 className="text-xl font-semibold mt-8 mb-2">How to manage cookies</h2>
      <p>
        You can set your browser to refuse cookies or delete existing ones.
        However, disabling cookies may affect functionality and personalization
        on CineNiche.
      </p>
      ...
      <p>
        CineNiche regularly reviews and updates this policy. All changes will be
        posted on this page. This version was last updated on April 11, 2025.
      </p>
